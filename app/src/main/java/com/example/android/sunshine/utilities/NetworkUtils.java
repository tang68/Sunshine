...
public final class NetworkUtils {
    ...
    private static final String STATIC_WEATHER_URL = "https://api.openweathermap.org/data/2.5/forecast?";
    ...
    private static final String APIKey = "3947eb120621a70df8a30a7d426bb053";
